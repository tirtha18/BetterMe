            ...
            <div className=" flex flex-col">
                ...
                <div className="w-[600px] bg-lightBlue h-60 rounded-lg flex flex-row items-center justify-center">
                    ...
                    <div className="flex flex-col text-white">
                        ...
                        <h2 className=" mb-12 text-gray-200">mark.zuck@gmail.com</h2>
                        <div className=" text-xl flex flex-row space-x-8"><p>170 cms</p> <p>75 kgs</p> <p>BMI - 42</p></div>
                    </div>
                </div>
