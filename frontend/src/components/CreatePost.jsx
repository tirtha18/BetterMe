...
const CreatePost = () => {
    ...
    const handlePost = async () => {
        try {
            const response = await httpclient.post("//localhost:5000/create_post", {
                title,
                content,
                image_link
            })
        ...
        <div>
            <div className='pt-14'>
                ...
                <div className="editor mx-auto w-10/12 flex flex-col text-gray-800 p-4 shadow-lg max-w-2xl">
                    ...
                    <textarea className="description bg-[#e9ffff] sec p-3 h-60 outline-none font-poppins" spellCheck="false" placeholder="Describe everything about your post here" onChange={(e) => setContent(e.target.value)}></textarea>
