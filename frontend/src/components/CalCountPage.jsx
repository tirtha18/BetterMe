...
const CalCountPage = () => {
    ...
    const handlePost = async () => {
        try {
            ...
            const response = await httpClient.post('http://127.0.0.1:5000/visual', formData);
    ...
    return (
        <div className="pt-20 h-full flex items-center justify-center">
            <div className="editor mx-auto w-10/12 flex flex-col text-gray-800 p-4 shadow-xl max-w-2xl">
                <div className="heading text-center font-poppins font-semibold text-2xl m-5 text-lightBlue">Visual Search</div>
